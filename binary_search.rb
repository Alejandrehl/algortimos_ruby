...
#Así como el ejercicio anterior, en esta implementación se busca encontrar el index dentro de los valores
#que se pasan. Se busca la mitad y se itera dependiendo si value es mayor o menor a target,
#si no, se devuelve el último valor como el index que se buscaba.